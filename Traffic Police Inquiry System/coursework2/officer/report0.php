...
?>
<body>	
	<form action="http://mersey.cs.nott.ac.uk/~alysg10/coursework2/officer/report.php" method="post" name="indexf">
	...
	<p align="center"><input type="button" value="Add" name="inbut" onClick="location.href='http://mersey.cs.nott.ac.uk/~alysg10/coursework2/officer/reportadd.php'" />
