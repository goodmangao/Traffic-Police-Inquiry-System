...
?>
<body>	
	<form action="http://mersey.cs.nott.ac.uk/~alysg10/coursework2/officer/car.php" method="post" name="indexf">	
	...
	<p align="center"><input type="button" value="Add" name="inbut" onClick="location.href='http://mersey.cs.nott.ac.uk/~alysg10/coursework2/officer/vehicleadd.php'" />
	...
	<table align="center" border="1px" cellspacing="0px" width="900px";>
		<tr><th>ID</th><th>TYPE</th><th>COLOR</th><th>LICENCE</th><th>OWNER</th><th>OWNER LICENCE</th></tr>
</body>
</html>
