...
?>
<body>
	<form action="http://mersey.cs.nott.ac.uk/~alysg10/coursework2/administrator/owner.php" method="post" name="indexf">
 ...
 <?php
	...
	if (empty($_POST["selsub"])){
		$res = mysqli_query($link,"select * from People by People_ID;");//Full result set
	}else{
		$sel = $_POST["sel"];
